...
int main() {
    ...
    arr[0] = { "Buyalskiy","Group1",{80,95,85,90,80} };
    arr[1] = { "Buschcan","Group2",{75,85,70,90,95} };
...
int main() {
    Man people[8] = {
        ...
        {"Simonenko", "Bogdan", 36, "1987-02-15"},
        {"Zhurakovskyi", "Maksim", 26, "1997-01-27"},
        {"Yarmolenko", "Andriy", 30, "1993-05-22"},
        {"Mudryk", "Michailo", 23, "2000-08-03"},
        {"Tsygankow", "victor", 25, "1998-11-01"},
    ...
    sort(people, people + 10, [](Man a, Man b) 
        {
